...
export default function ManufacturerDetail() {
  ...
  const manufacturer = getManufacturer(Number(id));
  const manufacturerProducts = getManufacturerProducts(Number(id));

  return (
    <>
      {manufacturer === undefined ? (
        <h1 className="section-title">Distribuidor no encontrado</h1>
      ) : (
        <>
